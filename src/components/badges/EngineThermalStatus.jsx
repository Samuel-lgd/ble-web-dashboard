    ...
    <div className="w-full h-full flex items-center justify-center">
      <svg viewBox="-44 -44 88 88" className="w-full h-full" style={{ overflow: 'visible' }}>
        <defs>
          ...
          <linearGradient id="eng-bezel-ring" x1="0" y1="0" x2="1" y2="1">
        ...
        {/* Chrome bezel */}
        <circle cx="0" cy="0" r="42" fill="url(#eng-bezel-ring)" stroke="#1a1a1c" strokeWidth="0.6" />
        <circle cx="0" cy="0" r="39" fill="url(#eng-face)" />
